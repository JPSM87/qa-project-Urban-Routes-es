...
class TestUrbanRoutes:
    ...
    def test_select_comfort_(cls):

        order_cab_click = UrbanRoutesP.UrbanRoutesPage(cls.driver)
        order_cab_click.select_comfort_tariff()
        # Aserción para verificar si se ha seleccionado la tarifa, Los selectores proporcionados no eran únicos y el código
        #Al intentar ocupar el selector como CSS y como CLASS_NAME 'tcard active', no lo me lo toma, así que recurrí a este método utilizando la presencia de la opción de mantas y pañuelos.
